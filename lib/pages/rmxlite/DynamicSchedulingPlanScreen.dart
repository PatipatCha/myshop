...
class DynamicSchedulingPlanScreen extends StatefulWidget {
  DynamicSchedulingPlanScreen({key, this.title}) : super(key: key);

  final String title;

  @override
  _DynamicSchedulingPlanScreenState createState() =>
      _DynamicSchedulingPlanScreenState();
}
...
class _DynamicSchedulingPlanScreenState
    extends State<DynamicSchedulingPlanScreen> {
